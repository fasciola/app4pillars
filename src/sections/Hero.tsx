        ...
        <div className="min-h-[72vh] flex items-center">
          <div className="max-w-4xl text-left">
            ...
            <div className="mt-9 flex flex-col sm:flex-row items-start gap-4">
              ...
              <button
                onClick={onServices}
                className="px-8 py-4 rounded-full text-sm text-white/70 hover:text-white transition-colors duration-300 border border-white/15 hover:border-white/30 bg-black/20 backdrop-blur-sm"
              >
